...
Writeln('¬ведите номер команды которую хотите использовать:');
Writeln('ƒл€ завершени€ работы программы введите 0');
read(l);
if l=1 then
begin
Writeln('¬ведите количество векторов которое хотите создать с рандомными значени€ми');
read(l);
b.create_random(l);
end
else if l=2 then
...
begin
Writeln('¬ведите координаты вектора, который хотите создать: ');
read(x);
read(y);
read(z);
a.create(x,y,z);
